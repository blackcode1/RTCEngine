...
public class TaskState {
    ...
    public Map<String, List<String>> getMapState() {
    ...
    public void setMapState(Map<String, List<String>> mapState) {
        this.mapState = mapState;
        this.timeStamp = new Date().getTime();
    }

    public void addMapState(String key, String value){
    ...
    public void updateMapState(String key, List<String> value){
    ...
    public void addListState(String value){
        this.listState.add(value);
        this.timeStamp = new Date().getTime();
    }

    public void setListState(List<String> list){
        this.listState = new ArrayList<String>();
